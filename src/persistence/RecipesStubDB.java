 ...
 * 
 */
public class RecipesStubDB implements DAO<Recipes> {
	...
	public RecipesStubDB() {
		...
		String ingredients1 = "1 large russet potato, salt,pepper,1 tablespoon butter,1 tablespoon sour cream";
